    ...
    <div className="min-h-screen relative w-full overflow-hidden bg-gradient-to-tr from-black via-neutral-700/60 to-black flex flex-col items-center justify-center rounded-lg">
      ...
      <div className="relative inline-block">
        ...
        <motion.div
          ...
          className="relative text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500" // Wrapper ko poori width di
        >
      ...
      <TypewriterEffectSmooth
        ...
        className="relative z-20 text-lg sm:text-sm text-gray-300 mb-8 mx-auto mt-4"
      />
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
